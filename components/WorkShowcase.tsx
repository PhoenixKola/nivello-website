...
const copy = {
  en: {
    ...
    intro: 'Developed websites for the public side of a business, and custom web apps for the work happening behind it.',
    explore: 'Explore the work',
    websiteNav: 'Websites & landing pages',
    websiteNavNote: 'Next.js, performance, maintainability',
    ...
    websitesIntro: 'Responsive, maintainable builds with the design and messaging support each product needs.',
  ...
  it: {
    ...
    intro: 'Siti sviluppati per il lato pubblico del business e app web custom per il lavoro che avviene dietro le quinte.',
    explore: 'Esplora i lavori',
    websiteNav: 'Siti & landing page',
    websiteNavNote: 'Next.js, performance, manutenzione',
