...
const projects = [
  ...
  { href: 'https://yourassistinitaly.it/', shot: '/work-yourassist.webp', category: 'Servizi expat', title: 'Your Assist in Italy', desc: 'Sito bilingue per una consulenza immigrazione a Firenze, pensato per expat che devono orientarsi tra permessi e autorizzazioni.', details: ['Pagine servizio in inglese e italiano', 'Percorsi chiari per consulenza', 'FAQ e testimonianze per fiducia'], color: '#DC2626' }
]
