...
const steps = [
  ...
  { title: 'Sviluppo e implementazione', description: 'Implementiamo la direzione approvata con attenzione a performance e accessibilita.', clientView: 'Una preview staging da testare su desktop e mobile.', duration: '1-2 settimane', icon: Code2, color: 'var(--brand-blue)' },
